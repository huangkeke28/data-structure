...
class Node2 {
    public int data;   // 数据
    public Node2 next = null;  // 下一个节点的位置
...
public class LinkedList2 {
    ...
    // 给定 index 下标, 找到对应的节点
    private Node2 getPos(int index) {
        Node2 cur = head;
    ...
    public void remove(int toRemove) {
        ...
        Node2 prev = searchPrev(toRemove);
        // 3. 修改引用的指向, 完成删除
    ...
    private Node2 searchPrev(int toRemove) {
        // 找到 toRemove 的前一个节点
        for (Node2 cur = head; cur != null
